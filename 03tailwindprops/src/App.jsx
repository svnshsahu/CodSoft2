...
function App() {
  ...
  return (
    <>  
    {/* jsx mein agar class dena hai toh class nahi likhte ..... we write className similarly agar for likhna hai toh htmlfor */}
      <h1 className='bg-green-400 text-black rounded-xl '>Hello Tailwind</h1>



{/* filhal ke lie ye tailwind wala part hata dete hai  */}
{/* <nav class="relative bg-gray-800/50 after:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-white/10">
  ...
  <el-disclosure id="mobile-menu" hidden class="block sm:hidden">
    ...
    <Cards/> 
    {/* <Cards/>    BUT DONO CARD SAME AAEGA USSE BADHIA KUCH INPUT DO JO PROPSSSS KE HELP SE CARD MEIN CHANGES HONGI */}


        <Cards channel="chai aur code"/>
    {/* ham chahe toh ek se jaada value bhi pass kar sakte hai  */}
    {/* we cant pass array like myArr=[1,2,3] not object like myArr={u:"s"} */}
    {/* not directly someObj = myObj  BUT WE VAN PASS A OBJECT AS A VARIABLE  */}
    <Cards channel="hii" someObj={myObj}/>
    <Cards channel="hii" someArr={newArr}/>

{/* ab yah a pura CARDDDD banane se accha yaha sirf card ko call kr le aur card ko as a component bana le  */}
